...
impl Token {
    ...
    pub fn from_command(command: &str) -> Token {
        match command {
            ...
            "mathnormal"          => Token::Style(Variant::Normal),
            ...
            "textit"              => Token::Text(Variant::Italic),
            "textrm"              => Token::Text(Variant::Normal),
            "textnormal"          => Token::Text(Variant::Normal),
            "text"                => Token::Text(Variant::Infer),
            "textsf"              => Token::Text(Variant::SansSerif),
            "textbf"              => Token::Text(Variant::Bold),
            "texttt"              => Token::Text(Variant::Monospace),
            "sqrt"                => Token::Sqrt,
            "frac"                => Token::Frac,
            "left"                => Token::Left,
            "right"               => Token::Right,
            ...
            "lmoustache"          => Token::Paren("⎰"),
            "rmoustache"          => Token::Paren("⎱"),

            "ulcorner"            => Token::Paren("┌"),
            "llcorner"            => Token::Paren("└"),
            "urcorner"            => Token::Paren("┐"),
            "lrcorner"            => Token::Paren("┘"),
            ...
            "mathring"            => Token::Over('˚', Accent::True),
            ...
            "overgroup"           => Token::Over('⏠', Accent::True),
            "undergroup"          => Token::Under('⏡', Accent::True),

            "overrightarrow"      => Token::Over('→', Accent::True),
            "overleftarrow"       => Token::Over('←', Accent::True),
            "underleftarrow"      => Token::Under('←', Accent::True),
            "underrightarrow"     => Token::Under('→', Accent::True),
            
            "underleftrightarrow" => Token::Under('↔', Accent::True),
            "overleftrightarrow"  => Token::Over('↔', Accent::True),

            "overrightharpoon"    => Token::Over('⇀', Accent::True),
            "overleftharpoon"     => Token::Over('↼', Accent::True),
            "underrightharpoon"   => Token::Under('⇀', Accent::True),
            "underleftharpoon"    => Token::Under('↼', Accent::True),
